...
namespace AppointmentBooking.Data
{
    public partial class HospitalManagementDbContext : DbContext
    {
        ...
        public virtual DbSet<TblSampleRegistration> TblSampleRegistrations { get; set; } = null!;
        public virtual DbSet<TblTestGroupSetup> TblTestGroupSetups { get; set; } = null!;
        public virtual DbSet<TblTestParameterMapping> TblTestParameterMappings { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblLabParameterSetup>(entity =>
            {
                entity.HasKey(e => e.ParameterId);

                entity.ToTable("tblLabParameterSetup");
            ...
            modelBuilder.Entity<TblResultEntry>(entity =>
            {
                entity.ToTable("tblResultEntry");
            ...
            modelBuilder.Entity<TblSampleRegistration>(entity =>
            {
                entity.HasKey(e => e.SrNo);

                entity.ToTable("tblSampleRegistration");

                entity.Property(e => e.CreatedDate).HasColumnType("date");

                entity.Property(e => e.IsCollected).HasColumnName("isCollected");
            ...
            modelBuilder.Entity<TblTestParameterMapping>(entity =>
            {
                entity.ToTable("tblTestParameterMapping");

                entity.HasOne(d => d.Paramater)
                    .WithMany(p => p.TblTestParameterMappings)
                    .HasForeignKey(d => d.ParamaterId)
